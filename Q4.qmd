...
```{r}
# Example list of data frames (you should replace these with your actual data)
...
arrow(length = unit(0.07, "inches"), ends = "last", type = "open")) + labs(title = paste0("Null plot"),
                                                                           subtitle = "Total passes by Australia")
})
