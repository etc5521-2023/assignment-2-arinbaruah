...
Based on the description above, following are the two open-ended questions which may be interesting to answer:
...
2. Is there a popular dimensional ratio of devices (Height:Width) which users prefer ?
